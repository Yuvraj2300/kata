...
class Parent {
    public Parent() {
        System.out.println("Parent Constructor Loading");
    }

    static {
        System.out.println("Parent static Loading");
    }

    {
        System.out.println("Parent code block Loading");
    }
}
...
class Child extends Parent {
    ...
    static {
        System.out.println("Child static Loading");
    }

    {
        System.out.println("Child code block Loading");
    }
